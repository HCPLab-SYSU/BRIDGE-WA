...
class VisionAction(PreTrainedModel):
    """
    VisionAction: HuggingFace-compatible Vision-Language-Action policy.
    ...
    """
    config_class = VisionActionConfig
    base_model_prefix = "vision_action"
    supports_gradient_checkpointing = True

    def __init__(self, config: VisionActionConfig, *args, **kwargs):
    ...
    def _build_app(self, processor):
        """
        Minimal FastAPI app for VisionAction inference.
