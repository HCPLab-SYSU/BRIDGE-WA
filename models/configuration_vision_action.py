...
class VisionActionConfig(PretrainedConfig):
    """
    Configuration class for the **VisionAction (Extended Vision-Language-Action)** model.

    This configuration defines all submodules of VisionAction in a single place:
      - The visual-language backbone (Florence2)
      - The temporal/action transformer
      - The action/proprio setup
    """

    model_type = "vision_action"
