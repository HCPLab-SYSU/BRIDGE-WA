...
class VisionActionProcessor(ProcessorMixin):
    """
    VisionActionProcessor: Unified multimodal processor for VisionAction models.
    ...
    so that users can call it directly like:
        ...
        >>> processor = VisionActionProcessor.from_pretrained("path/to/vision_action")
    ...
    def __init__(self, image_processor=None, tokenizer=None):
        """
        Initialize VisionActionProcessor.
